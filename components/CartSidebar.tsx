      ...
      <aside className="w-full sm:w-96 bg-white dark:bg-gray-900 border-l p-4 overflow-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => toggleOpen(false)} className="px-2 py-1 border rounded">Close</button>
          </div>
        </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="space-y-4">
              ...
              <div key={it.slug} className="flex items-center justify-between gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <button onClick={() => updateQty(it.slug, it.quantity - 1)} className="px-2 py-0.5 border rounded">-</button>
                ...
                <div className="text-right">
                  ...
                  <button onClick={() => removeItem(it.slug)} className="text-xs text-red-500 mt-2">Remove</button>
                </div>
              </div>
            ))}
            ...
            <div className="mt-4 flex gap-2">
              <Link href="/cart" className="flex-1 text-center px-4 py-2 border rounded">View Cart</Link>
              <button className="flex-1 bg-indigo-600 text-white px-4 py-2 rounded">Checkout</button>
            </div>
          </div>
        )}
      </aside>
